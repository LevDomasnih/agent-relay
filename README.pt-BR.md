...
Esta é uma versão v0.1-ready. CLI, core package, MCP server, state migrations, CI checks e package dry-runs estão implementados e testados. Os packages npm ainda não foram publicados.
