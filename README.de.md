...
Agent Relay v0.1.3 ist auf npm veröffentlicht. CLI, core package, MCP server, state migrations, CI checks, release dry-runs und npm smoke test sind implementiert und verifiziert.
